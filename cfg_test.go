...
func Test_Config_GetString(t *testing.T) {
	cases := []struct {
		...
		},
		{
			...
			loader:   newTestLoader(map[string]any{"key:nested": "val"}, nil),
			key:      "key:nested",
			expected: "val",
			isErr:    false,
		},
		{
			...
			loader:   newTestLoader(map[string]any{"key_test": "val"}, nil),
			key:      "keytest",
			expected: "val",
			isErr:    false,
		},
...
func Test_Config_GetInt(t *testing.T) {
	cases := []struct {
		...
		{
			name:     "Happy path nested",
			loader:   newTestLoader(map[string]any{"key:nested": 5}, nil),
			key:      "key:nested",
			expected: 5,
			isErr:    false,
		},
		{
			name:     "With underscore",
			loader:   newTestLoader(map[string]any{"key_test": 5}, nil),
			key:      "keytest",
			expected: 5,
			isErr:    false,
		},
...
func Test_Config_GetFloat64(t *testing.T) {
	cases := []struct {
		...
		{
			name:     "Happy path nested",
			loader:   newTestLoader(map[string]any{"key:nested": float64(74)}, nil),
			key:      "key:nested",
			expected: 74,
			isErr:    false,
		},
		{
			name:     "With underscore",
			loader:   newTestLoader(map[string]any{"key_test": float64(74)}, nil),
			key:      "keytest",
			expected: 74,
			isErr:    false,
		},
